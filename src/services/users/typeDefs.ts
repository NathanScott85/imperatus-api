...
const combinedTypeDefs = [typeDefs, productTypeDefs, categoryTypeDefs, carouselTypeDefs, promotionTypeDefs, productSetsTypeDefs, brandsTypeDefs, productTypesTypeDefs, rarityTypeDefs];
